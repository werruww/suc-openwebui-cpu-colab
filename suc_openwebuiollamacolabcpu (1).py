...
# --- Configuration ---
NGROK_TOKEN = "XXXXXXX"  # Replace with your token if needed
...
if public_url:
    ...
    print(f"❌ Ngrok failed to start within {wait_time} seconds. Check logs.")
...
try:
    ...
    print(f"\nOpen WebUI process finished with return code: {rc}")
     ...
     print(f"❌ Error: 'open-webui' command not found. Make sure it's installed and in your PATH.")
except Exception as e:
